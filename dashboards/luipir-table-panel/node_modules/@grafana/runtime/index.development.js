...
var DataSourceWithBackend = /** @class */ (function (_super) {
    ...
    DataSourceWithBackend.prototype.query = function (request) {
        ...
        var orgId = config.bootData.user.orgId;
        ...
        var queries = targets.map(function (q) {
            ...
            if (q.datasource) {
                var dsName = q.datasource === 'default' ? config.defaultDatasource : q.datasource;
                var ds = config.datasources[dsName];
                if (!ds) {
        ...
        var req = getBackendSrv()
            ...
            .then(function (rsp) {
            var dqs = toDataQueryResponse(rsp);
            ...
            var dqs = toDataQueryResponse(err);
            if (_this.processResponse) {
                return _this.processResponse(dqs);
            }
            return dqs;
