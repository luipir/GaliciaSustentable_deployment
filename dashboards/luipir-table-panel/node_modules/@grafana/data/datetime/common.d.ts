 ...
 * @internal
 */
export declare const setTimeZoneResolver: (resolver: TimeZoneResolver) => void;
/**
 ...
 * @internal
 */
export declare const getTimeZone: <T extends DateTimeOptions>(options?: T | undefined) => TimeZone;
