...
var updateCiConfig = useSpinner_1.useSpinner('Updating CircleCI config', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        ...
        sourceFile = path.join('node_modules/@grafana/toolkit/config/circleci', 'config.yml');
        destFile = path.join(ciConfigPath, 'config.yml');
        fs.copyFileSync(sourceFile, destFile);
        return [2 /*return*/];
    });
}); });
var pluginUpdateRunner = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, updateCiConfig({})];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
