...
var gaugePanelMigrationHandler = function gaugePanelMigrationHandler(panel) {
  return Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["sharedSingleStatMigrationHandler"])(panel);
}; // This is called when the panel changes from another panel

var gaugePanelChangedHandler = function gaugePanelChangedHandler(panel, prevPluginId, prevOptions) {
  // This handles most config changes
  var opts = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["sharedSingleStatPanelChangedHandler"])(panel, prevPluginId, prevOptions); // Changing from angular singlestat
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(GaugePanel, _super);

  function GaugePanel() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.currentMetricValue = undefined;
    _this.currentMetricColor = undefined;
    ...
    _this.renderComponent = function (valueProps, menuProps) {
      ...
      var field = value.field,
          display = value.display; // get min/max range from propagated default min/max classes
      ...
      var grafanaConfig = _grafana_runtime__WEBPACK_IMPORTED_MODULE_2__["config"];
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Gauge"], {
        value: display,
        width: width,
        height: height,
        field: field,
    ...
    _this.renderValue = function (valueProps) {
      ...
      var getLinks = value.getLinks,
          hasLinks = value.hasLinks; // In case metric is string and not value, set correctly what to display as value
      // and color.

      if (isNaN(_this.currentMetricValue)) {
        ...
        value.display.numeric = _this.props.data.series[0].fields[0].values.buffer[0]; // set color and text to display for a non numeric value

        value.display.text = String(_this.currentMetricValue);
        value.display.color = _this.currentMetricColor;
      }

      if (hasLinks && getLinks) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["DataLinksContextMenu"], {
          links: getLinks
        }, function (api) {
  ...
  GaugePanel.prototype.forcePanelProps = function () {
    var index;
    var classes;
    var variable;
    var dataSource = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_2__["getDataSourceSrv"])();
    variable = _.find(dataSource.templateSrv.getVariables(), {
      'name': INDEX
    });
    variable = _.find(variable.options, {
      'selected': true
    });
    variable.text == "None" ? index = null : index = variable.text;
    ...
    this.props.fieldConfig.defaults.thresholds.mode = 'absolute'; // manage returned value in case of categorised values
    ...
    if (isNaN(this.currentMetricValue)) {
      ...
      this.props.data.series[0].fields[0].config.mappings = mapping; // give to the category value (e.g metric) the index class + 0.5 to have the Gauge pointer
      // pointing in the middle of the category
      // const category_value = this.props.data.series[0].fields[0].values.buffer[0]

      var numeric_value = undefined;

      for (var i = 0; i < classes.length; i++) {
        if (this.currentMetricValue == classes[i].value) {
          numeric_value = i + 0.5; // set the color of the text basing on value

          this.currentMetricColor = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["getColorFromHexRgbOrName"])(classes[i].color);
          break;
        }
  ...
  GaugePanel.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["VizRepeater"], {
      ...
      orientation: _grafana_data__WEBPACK_IMPORTED_MODULE_3__["VizOrientation"].Auto
    });
  };
...
/* harmony import */ var _GaugePanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GaugePanel */ "./GaugePanel.tsx");
/* harmony import */ var _stat_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stat/types */ "./stat/types.ts");
/* harmony import */ var _GaugeMigrations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GaugeMigrations */ "./GaugeMigrations.ts");




var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["PanelPlugin"](_GaugePanel__WEBPACK_IMPORTED_MODULE_1__["GaugePanel"]).useFieldConfig().setPanelOptions(function (builder) {
  Object(_stat_types__WEBPACK_IMPORTED_MODULE_2__["addStandardDataReduceOptions"])(builder, false);
...
}).setPanelChangeHandler(_GaugeMigrations__WEBPACK_IMPORTED_MODULE_3__["gaugePanelChangedHandler"]).setMigrationHandler(_GaugeMigrations__WEBPACK_IMPORTED_MODULE_3__["gaugePanelMigrationHandler"]);
