...
(function (global, factory) {
  ...
  (global = global || self, global.Sunburst = factory());
  ...
  var sunburst = index({
      ...
      _parseData: function _parseData(state) {
        if (state.data) {
          ...
          if (state.excludeRoot) {
            ...
            var yScale = linear$1().domain([hierData.y1 - hierData.y0, 1]);
    ...
    init: function init(domNode, state) {
      ...
      state.radiusScale = sqrt();
      state.angleScale = linear$1().domain([0, 10]) // For initial build-in animation
      ...
      state.tooltip = d3Select('body').append('div').attr('class', 'sunburst-tooltip'); // tooltip cleanup on unmount
