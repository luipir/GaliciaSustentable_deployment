...
var sunburst = Kapsule({
  ...
  init: function init(domNode, state) {
    ...
    state.radiusScale = d3Scale.scaleSqrt();
    ...
    state.tooltip = d3Selection.select('body').append('div').attr('class', 'sunburst-tooltip'); // tooltip cleanup on unmount
  ...
  update: function update(state) {
    ...
    allSlices.select('.path-label').transition(transition).styleTween('display', function (d) {
      return function () {
