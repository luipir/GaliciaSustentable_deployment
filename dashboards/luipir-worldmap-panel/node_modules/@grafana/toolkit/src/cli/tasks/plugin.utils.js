...
var releaseNotes = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, execa.shell("awk 'BEGIN {FS=\"##\"; RS=\"##\"} FNR==3 {print \"##\" $1; exit}' CHANGELOG.md")];
            case 1:
...
var prepareRelease = useSpinner_1.useSpinner('Preparing release', function (_a) {
    ...
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var ciDir, distDir, distContentDir, pluginJsonFile, pluginJson, githubPublishScript, _b, githubPublishScript_1, githubPublishScript_1_1, line, opts, command, args, stdout, ex_1, err, trueError, _c, _d, regex, e_1_1;
        var e_1, _e, e_2, _f;
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    pluginJson = pluginValidation_1.getPluginJson(pluginJsonFile);
                    _b = [['git', ['config', 'user.email', DEFAULT_EMAIL_ADDRESS]],
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _c = [void 0, githubToken, githubUser, gitRepoName];
...
var githubPublishRunner = function (_a) {
    ...
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var repo, parsedUrl, githubToken, githubUser;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!!process.env['CIRCLE_REPOSITORY_URL']) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    if (repo && repo.stdout) {
                        ...
                        throw new Error('The release plugin requires you specify the repository url as environment variable CIRCLE_REPOSITORY_URL');
                    }
                    _b.label = 2;
                case 2:
