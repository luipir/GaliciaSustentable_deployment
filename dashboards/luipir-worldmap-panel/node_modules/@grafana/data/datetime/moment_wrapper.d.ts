...
export declare const toUtc: (input?: string | number | DateTime | Date | (string | number)[] | null | undefined, formatInput?: FormatInput) => DateTime;
export declare const toDuration: (input?: string | number | DateTimeDuration | undefined, unit?: "year" | "years" | "y" | "month" | "months" | "M" | "week" | "weeks" | "w" | "day" | "days" | "d" | "hour" | "hours" | "h" | "minute" | "minutes" | "m" | "second" | "seconds" | "s" | "millisecond" | "milliseconds" | "ms" | "quarter" | "quarters" | "Q" | undefined) => DateTimeDuration;
export declare const dateTime: (input?: string | number | DateTime | Date | (string | number)[] | null | undefined, formatInput?: FormatInput) => DateTime;
export declare const dateTimeAsMoment: (input?: string | number | DateTime | Date | (string | number)[] | null | undefined) => moment.Moment;
export declare const dateTimeForTimeZone: (timezone?: string | undefined, input?: string | number | DateTime | Date | (string | number)[] | null | undefined, formatInput?: FormatInput) => DateTime;
