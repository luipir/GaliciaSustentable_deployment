...
var ReactMonaco = _interopDefault(require('react-monaco-editor'));
...
var UnthemedCodeEditor = /** @class */ (function (_super) {
    ...
    UnthemedCodeEditor.prototype.render = function () {
        ...
        return (React__default.createElement("div", { onBlur: this.onBlur },
            React__default.createElement(ReactMonaco, { width: width, height: height, language: language, theme: theme.isDark ? 'vs-dark' : 'vs-light', value: value, options: options, editorWillMount: this.editorWillMount, editorDidMount: this.editorDidMount })));
    };
