...
export declare const getCheckboxStyles: (theme: GrafanaTheme) => {
    label: string;
    description: string;
    wrapper: string;
    input: string;
